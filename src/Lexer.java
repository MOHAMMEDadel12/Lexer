import java.io.*;
enum TokenType { WRITE,READ,IF,ELSE,RETURN,BEGIN,ERROR,
                 END,MAIN,STARTING,INT,REAL,SEMI,
                 COMMA,LPAREN,RPAREN,PLUS,MINUS,
                 MULTI,DIV,EQ,TESTEQ,TESTNOTEQ,
                 QUOTEDSTRING,IDENTIFIER,NUMBER,COMMENT}
class Token{
        String text;
        int begin;
        int end;
        ...
        public String toString() {
            return String.format("%s",text+"  ---->  "+" this token is "+text+" word and the type is "+type + "\n\t\t\t Start with index " +begin+ "\n\t\t\t and end with "+end+"\n\n");
        }
    }
...
"18:9,3:2,18,3:2,18:18,3,18,15,18:5,8,9,2,10,7,11,17,1,6,5:9,13,12,18,14,18:" +
"3,4:26,18,16,18:4,4:26,18:5,0:2")[0];

	private int yy_rmap[] = unpackFromString(1,26,
"0,1,2,1,3,4,1:6,5,6,1:3,7,1:2,8:2,9,10,11,12")[0];

	private int yy_nxt[][] = unpackFromString(13,19,
"1,2,3,17,4,5,18,6,7,8,9,10,11,12,19,21,19:3,-1:21,13,-1:20,4:3,-1:17,5:2,-1" +
":26,14,-1:6,23,-1:19,17,-1:18,20:4,-1:8,15,22,-1:19,20,-1:3,24,23:4,-1:14,2" +
"5,-1:17,16,-1:17");
